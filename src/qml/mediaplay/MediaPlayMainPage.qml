...
*/
    ...
    function closeaaa()
    {
        console.log("closeaaacloseaaacloseaaacloseaaa")
    }
...
//                handle: Rectangle {
//                    implicitWidth: 5 // 设置滑块手柄的宽度
//                    implicitHeight: 5 // 设置滑块手柄的高度
//                    radius: 2 // 设置滑块手柄的圆角半径

//                    color: "blue" // 设置滑块手柄的颜色
//                    border.color: "black" // 设置滑块手柄的边框颜色
//                    border.width: 1 // 设置滑块手柄的边框宽度

//                    // 你可以添加更多自定义样式，例如阴影、渐变等
//                }
